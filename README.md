...
This template built with [Next.js](https://nextjs.org), and the [Coinbase CDP](https://docs.cdp.coinbase.com/) shows off using x402 with a modern AI stack.
...
```bash
git clone https://github.com/pedrojoaorp/final-project-bitcoin
cd final-project-bitcoin
pnpm install
```
